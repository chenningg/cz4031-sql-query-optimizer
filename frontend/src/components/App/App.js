  ...
  return (
    <Container fluid="md">
      <div className={styles.headerWrapper}>
        ...
        <p className={styles.headerText}>Only allowable predicates have been added to the list, so don't be surprised if some attributes are missing! Allowable predicates include numeric and date attributes, and predicates can only be selected on attributes limited by a range condition in a WHERE clause (no equality conditions).</p>
      </div>
      <hr/>
      <FormInput/>
    </Container>
